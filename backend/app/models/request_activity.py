...
class RequestActivity(Base, UUIDMixin, TimestampMixin, TenantMixin):
    __tablename__ = "tb_request_activity"

    request_id: Mapped[str] = mapped_column(
        String(36), ForeignKey("tb_request.id", ondelete="CASCADE"), index=True
    )
    # STATUS_CHANGE / COMMENT / WO_GENERATED
