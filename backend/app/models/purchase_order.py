...
class PurchaseOrder(Base, UUIDMixin, TimestampMixin, SoftDeleteMixin, TenantMixin):
    ...
    # 收货信息细化（全可空；保留既有 shipping_address 等单串字段，不改语义）
    shipping_to_name: Mapped[str | None] = mapped_column(String(200), default=None)
    shipping_company_name: Mapped[str | None] = mapped_column(String(300), default=None)
    shipping_city: Mapped[str | None] = mapped_column(String(120), default=None)
    shipping_state: Mapped[str | None] = mapped_column(String(120), default=None)
    shipping_zip_code: Mapped[str | None] = mapped_column(String(40), default=None)
    shipping_phone: Mapped[str | None] = mapped_column(String(60), default=None)
    shipping_fax: Mapped[str | None] = mapped_column(String(60), default=None)
    requisitioned_by_name: Mapped[str | None] = mapped_column(String(200), default=None)
